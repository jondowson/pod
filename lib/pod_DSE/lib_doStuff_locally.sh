...
if [[ ${remote_os} == *"Mac"* ]]; then
  ...
  lib_generic_strings_sedStringManipulation "searchAndReplaceStringGlobal" "${tmp_working_folder}lib/pod_DSE/lib_script_launchRemotely.sh" "bin/bash" "${hashBang}"
  lib_generic_strings_sedStringManipulation "searchAndReplaceStringGlobal" "${tmp_working_folder}lib/pod_DSE/lib_doStuff_remotely.sh" "bin/bash" "${hashBang}"
  ...
  lib_generic_strings_sedStringManipulation "searchAndReplaceStringGlobal" "${tmp_working_folder}lib/pod_DSE/lib_script_launchRemotely.sh" "usr/local/bin/bash" "${hashBang}"
  lib_generic_strings_sedStringManipulation "searchAndReplaceStringGlobal" "${tmp_working_folder}lib/pod_DSE/lib_doStuff_remotely.sh" "usr/local/bin/bash" "${hashBang}"
