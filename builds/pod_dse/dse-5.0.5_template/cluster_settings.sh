...
# for remote servers, this settig will be auto-edited based on the value set in server's json file definition 
# if desired, DSE_SOFTWARE and pod can be copied to different folders on different machines
