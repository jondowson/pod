...
cluster_name="dse-5.0.x_name"                         # avoid special characters !!
...
dse_version="dse-5.0.x"                               # the dse tarball version to unpack
...
BUILDPATHS_WRITETEST="temp_folder;parent_data_folder;parent_log_folder;SPARK_FOLDER_LOCALDATA;SPARK_FOLDER_WORKERDATA;SPARK_FOLDER_MASTERLOG;SPARK_FOLDER_WORKERLOG"
