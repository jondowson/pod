...
lib_generic_display_msgColourSimple "INFO-BOLD" "[1] In terminal check bash for mac is version 4 or greater:"
...
lib_generic_display_msgColourSimple "INFO-BOLD" "[3] In new terminal repeat step [1]"
lib_generic_display_msgColourSimple "INFO"      "$ bash --version"
