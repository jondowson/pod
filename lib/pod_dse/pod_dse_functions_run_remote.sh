...
function pod_dse_remote_create_dse_folders(){
...
function pod_dse_remote_install_java_tar(){
...
function pod_dse_remote_install_dse_tar(){
...
function pod_dse_remote_install_dse_package_internet(){
...
function pod_dse_remote_install_dse_package_satellite(){
...
function pod_dse_remote_configure_dse_bash_profile(){
...
function pod_dse_remote_configure_java_bash_profile(){
...
function pod_dse_remote_configure_bashrc(){
