...
# -----
  ...
  ssh -ttq -o "BatchMode yes" -o "ForwardX11=no" ${user}@${pubIp} "chmod -R 700 ${target_folder}pod && ${target_folder}pod/pods/${WHICH_POD}/scripts/scripts_launchPodRemotely.sh" &                # run in parallel
