...
CLUSTER_NAME="FFP"                              # avoid special characters !!
...
PARENT_LOG_FOLDER="/apps/cassandra/log/"
PARENT_DATA_FOLDER="/apps/cassandra/data/"
