...
GENERIC_prepare_display_msgColourSimple "TASK" "Flags: pod_JAVA"
printf "%s\n"   "--------------------------------------------------------------------------------------------------"
...
GENERIC_prepare_display_msgColourSimple "INFO-BOLD" "(2) Check java version"
GENERIC_prepare_display_msgColourSimple "INFO"      "$ java -version"
}
