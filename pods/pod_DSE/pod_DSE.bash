...
if [[ "${clusterstateFlag}" == "true" ]]; then
  ...
  GENERIC_stages_stubs_test_sshConnectivity   "1" "3"
...
# installing pod_DSE
  ...
  GENERIC_stages_stubs_launchPod              "6" "7"   # this will execute non-generic functions on remote server (lib_doStuffRemotely.bash)
