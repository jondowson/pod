...
lib_generic_display_msgColourSimple "REPORT" "STAGE SUMMARY: ${reset}Remove named pod from each server"
...
if [[ "${pod_stop_dse_fail}" == "true" ]]; then
  ...
  lib_generic_display_msgColourSimple "SUCCESS" "Uninstall ${REMOVE_POD} from all servers"
fi
}
